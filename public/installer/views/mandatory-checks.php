...
<?php echo cardStart(
    ...
    $subtitle = "This installer will lead you through the most crucial Steps of Ptero-Billing's setup"
); ?>
...
<ul class="list-none mb-2">
    ...
    <li>
        <p class="text-neutral-400 mb-1">
            ...
            Ptero-Billing requires a MySQL-Database and Pterodactyl-Panel to work.<br>
