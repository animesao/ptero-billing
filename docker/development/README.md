...
2. **Custom Configuration:** Modify the Ptero-Billing Docker Compose configuration to use your current project as a base. If you point it to an empty folder, it will clone the repository, and you won't see your changes immediately.
