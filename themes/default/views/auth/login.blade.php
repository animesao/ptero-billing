    ...
    <div class="card card-outline card-primary">
      <div class="text-center card-header">
        ...
        @if ($website_settings->enable_login_logo)
          <img
            src="{{ \Illuminate\Support\Facades\Storage::disk('public')->exists('logo.png') ? asset('storage/logo.png') : asset('images/Ptero-Billing_logo.png') }}"
            alt="{{ config('app.name', 'Ptero-Billing') }} Logo"
