                            ...
                            <form action="{{ route('admin.servers.update', $server->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="identifier">{{ __('Server identifier') }}
                                        <i data-toggle="popover" data-trigger="hover"
                                            data-content="{{ __('Change the server identifier on Ptero-Billing to match a pterodactyl server.') }}"
                                ...
                                <div class="form-group">
                                    <label for="user_id">{{ __('Server owner') }}
                                        <i data-toggle="popover" data-trigger="hover"
                                            data-content="{{ __('Change the current server owner on Ptero-Billing and pterodactyl.') }}"
                                            class="fas fa-info-circle"></i>
                                    </label>
