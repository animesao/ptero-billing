                ...
                <div class="col-lg-4">
                    ...
                    @else
                        <div class="callout callout-danger">
                            ...
                            <p>{{ __('Are cronjobs running?')}} <a class="text-primary" target="_blank" href="https://Ptero-Billing/docs/Installation/getting-started#crontab-configuration">{{ __('Check the docs for it here')}}</a></p>
                        </div>
                    @endif
