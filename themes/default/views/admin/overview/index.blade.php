...
@section('content')
    ...
    <section class="content-header">
        ...
        @if(Storage::get('latestVersion') && config("app.version") < Storage::get('latestVersion'))
            <div class="alert alert-danger" role="alert">
                ...
                <a href="https://Ptero-Billing/docs/Installation/updating">{{__("Consider updating now")}}</a>
            </div>
        @endif
    </section>
    <!-- END CONTENT HEADER -->
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="mb-3 row">
                <div class="col-md-3">
                    <a href="https://github.com/animesao/ptero-billing/wiki" class="px-3 btn btn-dark btn-block"><i
                            class="mr-2 fas fa-link"></i> {{__('Documentation')}}</a>
                </div>
                <div class="col-md-3">
                    <a href="https://github.com/animesao/ptero-billing" class="px-3 btn btn-dark btn-block"><i
                            class="mr-2 fab fa-github"></i> {{__('Github')}}</a>
                </div>
                <div class="col-md-3">
                    <a href="https://github.com/animesao/ptero-billing#-поддержка-проекта" class="px-3 btn btn-dark btn-block"><i
                            class="mr-2 fas fa-money-bill"></i> {{__('Support Ptero-Billing')}}</a>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <div class="card-title ">
                                    <span><i class="mr-2 fas fa-server"></i>{{__('Ptero-Billing')}}</span>
                                </div>
                            </div>
                            <div class="py-1 card-body">
                            ...
                            @if ($perPageLimit)
                                <div class="m-2 alert alert-danger">
                                    ...
                                    <p class="mb-2">
                                        ...
                                        {{ __('Note') }}: {{ __('If this error persists even after changing the limit, it might mean a server was deleted on Pterodactyl, but not on Ptero-Billing. Try clicking the button below.') }}
                                    </p>
