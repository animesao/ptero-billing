...
<head>
    ...
    <meta
            content='{{ \Illuminate\Support\Facades\Storage::disk('public')->exists('logo.png') ? asset('storage/logo.png') : asset('images/Ptero-Billing_logo.png') }}'
            property="og:image">
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-open sidebar-dark-primary elevation-4">
        ...
        <a href="{{ route('home') }}" class="brand-link">
            <img width="64" height="64"
                 src="{{ \Illuminate\Support\Facades\Storage::disk('public')->exists('icon.png') ? asset('storage/icon.png') : asset('images/Ptero-Billing_logo.png') }}"
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2021-{{ date('Y') }} <a
                    href="{{ url('/') }}">{{ config('app.name', "Ptero-Billing") }}</a>.</strong>
        All rights
        reserved. Powered by <a href="https://Ptero-Billing">Ptero-Billing</a>.
